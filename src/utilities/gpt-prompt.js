...
a space ripe for mesmerizing talks and new acquaintances. Consider taking a stroll down 6th street and clearing your mind with a yoga session at Practice Yoga Austin on East 6th Street.
...
Craft a tailored prediction that adheres to a 350-character limit, and is both poetic and deeply resonating,
 ...
 Tie in something about the moon like in the example. Report rounded temperature. Be creative!
 Ensure to mention a specific nearby place or things BY NAME that the users location is known for (like parks, museums, or restaurants) AND the yoga studio. 
`;
}
